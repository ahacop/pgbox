...
| `apk_packages` | string[] | Alpine packages to install via apk |
| `yum_packages` | string[] | RHEL/CentOS packages to install via yum |
...
2. **Package names**: Must follow apt/apk/yum naming conventions
